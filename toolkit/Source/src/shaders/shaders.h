...
Cg/dynaShadowVS.cg              ->     Cg_dynaShadowVS_cg
...
GLSL/vAmbient.vs                ->     GLSL_vAmbient_vs
GLSL/vPixelLight.vs             ->     GLSL_vPixelLight_vs
GLSL/vPixelLightDiff.ps         ->     GLSL_vPixelLightDiff_ps
*/
