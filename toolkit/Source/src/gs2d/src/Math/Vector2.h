...
struct PODVector2
{
	...
	constexpr PODVector2& operator = (const PODVector2&) noexcept = default;
	constexpr PODVector2(PODVector2&&) noexcept = default;
	constexpr PODVector2& operator = (PODVector2&&) noexcept = default;
