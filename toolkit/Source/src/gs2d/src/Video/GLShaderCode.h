...
GL/default-sprite-add.fs        ->     GL_default_sprite_add_fs
GL/default-sprite-fast.vs       ->     GL_default_sprite_fast_vs
GL/default-sprite-modulate.fs   ->     GL_default_sprite_modulate_fs
GL/default-sprite-solid-color-add.fs->     GL_default_sprite_solid_color_add_fs
GL/default-sprite-solid-color-modulate.fs->     GL_default_sprite_solid_color_modulate_fs
GL/default-sprite-solid-color.fs->     GL_default_sprite_solid_color_fs
GL/default-sprite.fs            ->     GL_default_sprite_fs
GL/default-sprite.vs            ->     GL_default_sprite_vs
*/

namespace gs2d_gl_shaders {

const std::string GL_default_sprite_add_fs = 
"#version 330 core\n" \
...
const std::string GL_default_sprite_fast_vs = 
"#version 330 core\n" \
"\n" \
...
const std::string GL_default_sprite_modulate_fs = 
"#version 330 core\n" \
"out vec4 outFragColor;\n" \
"\n" \
"in vec4 outColor;\n" \
...
const std::string GL_default_sprite_solid_color_add_fs = 
"#version 330 core\n" \
"out vec4 outFragColor;\n" \
"\n" \
"in vec4 outColor;\n" \
...
const std::string GL_default_sprite_solid_color_modulate_fs = 
"#version 330 core\n" \
"out vec4 outFragColor;\n" \
"\n" \
"in vec4 outColor;\n" \
...
const std::string GL_default_sprite_solid_color_fs = 
"#version 330 core\n" \
"out vec4 outFragColor;\n" \
"\n" \
"in vec4 outColor;\n" \
...
const std::string GL_default_sprite_fs = 
"#version 330 core\n" \
"out vec4 outFragColor;\n" \
"\n" \
"in vec4 outColor;\n" \
...
const std::string GL_default_sprite_vs = 
"#version 330 core\n" \
"\n" \
"layout (location = 0) in vec3 inPosition;\n" \
"layout (location = 1) in vec2 inTexCoord;\n" \
